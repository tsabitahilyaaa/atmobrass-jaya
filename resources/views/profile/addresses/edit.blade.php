...
@section('title', 'Edit Alamat — CV Atmobrass Jaya')
...
<section class="py-10 sm:py-16 max-w-3xl mx-auto px-4 sm:px-6">
    <div class="mb-10">
        ...
        <h1 class="font-display font-bold text-3xl">Edit Alamat</h1>
        <p class="text-sm text-muted mt-2">Perbarui informasi alamat pengiriman Anda.</p>
    </div>
        ...
        <form method="POST" action="{{ route('profile.addresses.update', $address) }}">
            ...
            <div class="grid gap-6">
                <div>
                    ...
                    <input type="text" name="recipient_name" value="{{ old('recipient_name', $address->recipient_name) }}" required class="input-dark w-full px-4 py-3 rounded-2xl text-sm" />
                ...
                <div>
                    ...
                    <input type="tel" name="phone" value="{{ old('phone', $address->phone) }}" required class="input-dark w-full px-4 py-3 rounded-2xl text-sm" placeholder="08xxxxxxxxxx" />
                ...
                <div>
                    ...
                    <textarea name="address" rows="3" required class="input-dark w-full px-4 py-3 rounded-2xl text-sm resize-none" placeholder="Jl. ...">{{ old('address', $address->address) }}</textarea>
                ...
                <div class="grid sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="city" value="{{ old('city', $address->city) }}" required class="input-dark w-full px-4 py-3 rounded-2xl text-sm" />
                    ...
                    <div>
                        ...
                        <input type="text" name="province" value="{{ old('province', $address->province) }}" required class="input-dark w-full px-4 py-3 rounded-2xl text-sm" />
                ...
                <div>
                    ...
                    <input type="text" name="postal_code" value="{{ old('postal_code', $address->postal_code) }}" required class="input-dark w-full px-4 py-3 rounded-2xl text-sm" />
                    @error('postal_code') <p class="text-sm text-red-400 mt-2">{{ $message }}</p> @enderror
                </div>
                <div class="flex items-center gap-3">
                    <input id="is_default" type="checkbox" name="is_default" value="1" class="checkbox" {{ old('is_default', $address->is_default) ? 'checked' : '' }} />
